...
const PrivacyPolicy = () => {
    ...
    // Generated online with this site
    ...
    const sitePolicy = (
        <div className={"pt-2"}>
            ...
            <ul>
                ...
                <li>
                    <p><strong>Website</strong> refers to MaiFast, accessible from <a href="https://www.maifast.com"
                                                                                      rel="external nofollow noopener"
                                                                                      target="_blank">https://www.maifast.com</a>
                    </p>
                </li>
                <li>
            ...
            <ul>
                <li>By visiting this page on our website: <a href="https://www.maifast.com/help"
                                                             rel="external nofollow noopener"
                                                             target="_blank">https://www.maifast.com/help</a></li>
            </ul>
        </div>
